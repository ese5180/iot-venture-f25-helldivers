...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x102a9, (ISR)0x1764d}, /* 42 */
	...
	{(const void *)0x10059, (ISR)0x1764d}, /* 49 */
