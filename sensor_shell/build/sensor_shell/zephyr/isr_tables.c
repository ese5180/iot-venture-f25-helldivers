...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x103ed, (ISR)0x179e7}, /* 42 */
	...
	{(const void *)0x1019d, (ISR)0x179e7}, /* 49 */
